    ...
    return (
        <div className='mb-20'>
            ...
            <div className='flex justify-between items-center my-9'>
                ...
                <div>
                    <p className='font-medium text-xl text-gray-500'>{reading_time} mins read</p>
                </div>
            </div>
            ...
            <button className='underline text-xl font-semibold text-[#6047EC]'>Mark as read</button>
        </div>
    );
};
Blog.propTypes = {
